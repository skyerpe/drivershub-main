...
export default function AlltimeLeaderboard() {
    ...
    useEffect(() => {
        ...
        const a = async () => {
            ...
            const users = (await http.get<LeaderboardUser[]>("https://api.anchen.org/leaderboard/monthly")).data;
    ...
    return (
        <div className="flex flex-col text-center justify-center items-center">
            <div className="bg-gradient-to-b from-[#036374] to-[#043d47] shadow-lg shadow-[#036374]/40 backdrop-blur w-[90%] rounded-lg mt-6">
                <div className="text-white/80 font-semibold text-center text-3xl my-4">Monthly leaderboard</div>
            </div>
